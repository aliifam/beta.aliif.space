...
export default function Background() {
    return (
        <div className="bg-line h-screen flex">
            ...
            <Toaster/>
            <a className="absolute top-6 right-6 cursor-pointer" onClick={() => {toast("Still Under Construction!",{icon: '🚧', position: 'bottom center', style: {background: 'rgba(0, 0, 0, 0.8)', color: 'white',},duration: 2000,});}}>
            ...
            <a className="absolute bottom-2 right-4" href="mailto:me@aliif.space">
