    ...
    return (
        <div className="bg-line h-screen">
            <div className="container max-w-4xl h-screen mx-auto flex items-center">
                <div className="container flex flex-col mx-4 md:mx-0">
                    <h1 className="font-bold font-serif text-5xl sm:text-6xl mb-4">Aliif Arief</h1>
                    <p className="font-serif text-2xl">Hello, you can call me Aliif and I am Software Engineering student at Gadjah Mada University, I am Enjoyed coding with JavaScript and Python.</p>
                    <div className="grid grid-cols-6 max-w-xs mt-6">
                       <SocialIcon/>
                    </div>
                </div>
            </div>
            <a className="absolute top-6 right-4" href="">
                <svg className="w-11" width="57" height="40" viewBox="0 0 57 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a className="absolute bottom-2 right-4" href="">
